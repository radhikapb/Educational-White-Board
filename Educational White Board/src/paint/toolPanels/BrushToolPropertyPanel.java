 ...
 *
 */
public class BrushToolPropertyPanel extends ToolPropertyPanel {
	public JToolBar _bar = new JToolBar();
	public JLabel _name = new JLabel("Brush: ");
	public JLabel _width = new JLabel("  width ");
	public JLabel _widthValue = new JLabel("");
	public JSlider _slider = new JSlider();
	public BrushTool _tool;
	public BrushToolPropertyPanel(BrushTool tool)
	{
		_tool = tool;
		_tool.attach(this);
		//����������� ���������� ������ ������������
