...
import paint.tools.RectangleTool.Modes;
 ...
 *
 */
public class RectangleToolPropertyPanel extends ToolPropertyPanel
{
	public JToolBar _bar = new JToolBar();
	public JLabel _name = new JLabel("Rectangle        ");
	...
	public RectangleTool _tool;
	public RectangleToolPropertyPanel(RectangleTool tool)
	{
		_tool = tool;
		_tool.attach(this);
		//����������� ���������� ������ ������������
		...
		//������ ������
		_fill.setIcon(new ImageIcon(getClass().getResource("/icons/fillrectangle.PNG")));
		_fillBorder.setIcon(new ImageIcon(getClass().getResource("/icons/fillborderrectangle.PNG")));
		_border.setIcon(new ImageIcon(getClass().getResource("/icons/borderrectangle.PNG")));
