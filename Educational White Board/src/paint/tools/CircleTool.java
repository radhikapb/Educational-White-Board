...
public class CircleTool extends Tool {
			...
			if(_paintingOn && _inControl)
			{
				...
				if(point.x > _lastPoint.x)
					if(point.y > _lastPoint.y)
						//���� ���� ��������� ������ ����, ����� �� �����
						graf.drawOval(_lastPoint.x, _lastPoint.y,width,heigth);	
					else
						//���� ���� ��������� ����� �����, ����� �� �����
						graf.drawOval(_lastPoint.x,point.y,width,heigth);
				else
					if(point.y > _lastPoint.y)
						//���� ����  ��������� ������ ����, ������ �� ����
						graf.drawOval(point.x,_lastPoint.y,width,heigth);	
					else
						//���� ����  ��������� ����� �����, ������ �� ����
						graf.drawOval(point.x,point.y,width,heigth);
			...
			if(_paintingOn && _inControl)
			{
				...
				if((_mode == Modes.FillBorder) || (_mode == Modes.Fill))
				{
					...
					if(point.x > _lastPoint.x)
						if(point.y > _lastPoint.y)
							//���� ���� ��������� ������ ����, ����� �� �����
							graf.fillOval(_lastPoint.x, _lastPoint.y,width,heigth);	
						else
							//���� ���� ��������� ����� �����, ����� �� �����
							graf.fillOval(_lastPoint.x,point.y,width,heigth);
					else
						if(point.y > _lastPoint.y)
							//���� ���� ��������� ������ ����, ������ �� ����
							graf.fillOval(point.x,_lastPoint.y,width,heigth);	
						else
							//���� ���� ��������� ����� �����, ������ �� ����
							graf.fillOval(point.x,point.y,width,heigth);
	 ...
	 * @param buffer
	 */
	public CircleTool(CanvasModel canvas, ColorModel color, ImageBuffer buffer) 
	{
		_color = color;
		_canvas = canvas;
		_buffer = buffer;
